...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    |--------------------------------------------------------------------------
    |
    | DashboardController determina el dashboard según el rol.
    |
    */
    ...
    */
    ...
    Route::middleware('role:administrador')->group(function () {
        ...
        */
        ...
        Route::patch(
            'admin/pacientes/{paciente}/estado',
            [PacienteController::class, 'toggleEstado']
        ...
        */
        ...
        Route::get(
            ...
            [ProfesionalController::class, 'create']
        )->name('admin.profesionales.create');

        Route::post(
            'admin/profesionales',
            [ProfesionalController::class, 'store']
        ...
        Route::put(
            ...
            [ProfesionalController::class, 'update']
        ...
        */
        ...
        Route::get(
            'admin/auxiliares',
            [AuxiliarController::class, 'index']
        )->name('admin.auxiliares.index');

        Route::get(
            'admin/auxiliares/create',
            [AuxiliarController::class, 'create']
        )->name('admin.auxiliares.create');

        Route::post(
            'admin/auxiliares',
            [AuxiliarController::class, 'store']
        )->name('admin.auxiliares.store');

        Route::get(
            'admin/auxiliares/{auxiliar}',
            [AuxiliarController::class, 'show']
        )->name('admin.auxiliares.show');

        Route::get(
            'admin/auxiliares/{auxiliar}/edit',
            [AuxiliarController::class, 'edit']
        )->name('admin.auxiliares.edit');

        Route::put(
            'admin/auxiliares/{auxiliar}',
            [AuxiliarController::class, 'update']
        )->name('admin.auxiliares.update');

        Route::delete(
            'admin/auxiliares/{auxiliar}',
            [AuxiliarController::class, 'destroy']
        )->name('admin.auxiliares.destroy');

        Route::patch(
            'admin/auxiliares/{auxiliar}/estado',
            [AuxiliarController::class, 'toggleEstado']
        ...
        */
        ...
        Route::get(
            'admin/tiposervicios',
            [TipoServicioController::class, 'index']
        )->name('admin.tiposervicios.index');

        Route::get(
            'admin/tiposervicios/create',
            [TipoServicioController::class, 'create']
        )->name('admin.tiposervicios.create');

        Route::post(
            'admin/tiposervicios',
            [TipoServicioController::class, 'store']
        )->name('admin.tiposervicios.store');

        Route::get(
            'admin/tiposervicios/{tipoServicio}/edit',
            [TipoServicioController::class, 'edit']
        )->name('admin.tiposervicios.edit');

        Route::put(
            'admin/tiposervicios/{tipoServicio}',
            [TipoServicioController::class, 'update']
        )->name('admin.tiposervicios.update');

        Route::patch(
            'admin/tiposervicios/{tipoServicio}/estado',
            [TipoServicioController::class, 'toggleEstado']
        ...
        */
        ...
        Route::patch(
            'admin/servicios/{servicio}/estado',
    ...
    */
    ...
    Route::post(
        'logout',
        function (Request $request, Logout $logout) {
